package com.bridgelabz.employeewage;
	...
	public class ManageEmpWageMultiCompanyUseInterface implements IEmployeeWageComputation
	{
	    // class constants
	    ...
	    public ManageEmpWageMultiCompanyUseInterface (int noOfCompanies)
	    {
	    ...
	    {
	    	ManageEmpWageMultiCompanyUseInterface  manageWageMultipleCompanies = new ManageEmpWageMultiCompanyUseInterface (3);
