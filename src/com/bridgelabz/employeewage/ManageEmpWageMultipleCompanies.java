package com.bridgelabz.employeewage;
	...
	public class ManageEmpWageMultipleCompanies { 	
	    // class constants
	    ...
	    public ManageEmpWageMultipleCompanies(int noOfCompanies)
	    {
	    ...
	    {
	    	ManageEmpWageMultipleCompanies manageWageMultipleCompanies = new ManageEmpWageMultipleCompanies(3);
